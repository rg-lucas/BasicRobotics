function rotate_point_around_line(X, L, theta)

% X is the homogeneous coordinates of a point
% L is the Plucker coordinates of a line
% theta is the angle or rotation
